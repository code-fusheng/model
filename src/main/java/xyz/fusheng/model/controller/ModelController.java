...
public class ModelController {
    ...
    public ResultVo<Object> save(@RequestBody Model model){
        modelService.save(model);
        return new ResultVo<>("操作成功: 添加模版！");
    }
    ...
    public ResultVo<Object> deleteByIds(@RequestBody List<Integer> ids){
        ...
        return new ResultVo<>("操作成功: 批量删除模版！");
    }
    ...
    public ResultVo<Object> update(@RequestBody Model model){
    ...
    @GetMapping("/get/{id}")
    public ResultVo<Model> get(@PathVariable("id") Integer id){
        Model model = modelService.getById(id);
        return new ResultVo<>("操作成功: 查询模版！",model);
    }
    ...
    @GetMapping("/list")
    public ResultVo<List<Model>> list(){
        List<Model> modelList = modelService.getAll();
        return new ResultVo<>("操作成功: 查询模版列表！", modelList);
    }
    ...
    public ResultVo<Page<Model>> getByPage(@RequestBody Page<Model> page){
        ...
        return new ResultVo<>("操作成功: 分页查询模版！", page);
    }
    ...
    public ResultVo<Object> enable(@PathVariable("id") Integer id) {
    ...
    public ResultVo<Object> disable(@PathVariable("id") Integer id) {
