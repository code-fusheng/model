...
public class MusicController {
    ...
    @PostMapping("/save")
    public ResultVo<Object> save(@RequestBody Music music) {
        musicService.save(music);
        return new ResultVo<>("操作成功: 添加歌曲！");
    }
    ...
    public ResultVo<Music> getById(@PathVariable("id") Long id) {
        Music music = musicService.getById(id);
        return new ResultVo<>("操作成功: 查询歌曲！", music);
    }
     ...
     */
    @GetMapping("/list")
    public ResultVo<List<Music>> list() {
        List<Music> musics = musicService.list();
        return new ResultVo<>("操作成功: 歌曲列表！", musics);
    }
    ...
    public ResultVo<Page<Music>> getByPage(@RequestBody Page<Music> page) {
        ...
        return new ResultVo<>("操作成功: 分页查询歌曲！", page);
    }
