...
public class CategoryController {
    ...
    public ResultVo<Category> getById(@PathVariable("id") Long id){
        Category category = categoryService.getById(id);
        return new ResultVo<>("操作成功: 查询分类！", category);
    }
     ...
     */
    @GetMapping("/getAll")
    public ResultVo<List<Category>> getLAll() {
     ...
     */
    @GetMapping("/getList")
    public ResultVo<List<Category>> getList() {
    ...
    public ResultVo<Page<Category>> getByPage(@RequestBody Page<Category> page) {
